...
const Home = () => {
  ...
  const { data: apiResponse, isLoading, error, refetch } = useQuery({
    ...
    queryFn: async () => {
      ...
      try {
        ...
        console.log("API Response:", response.data); // Ensure response.data is returned
  ...
  const responseData = apiResponse || {}; // Ensure responseData is never undefined
  const posts = responseData?.data?.data ?? []; // Extract posts properly
